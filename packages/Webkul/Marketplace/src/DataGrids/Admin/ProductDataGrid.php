    ...
    public function prepareQueryBuilder()
    {
        if ( (core()->getConfigData('marketplace.settings.product_flag.enable'))) {
            ...
            $queryBuilder = DB::table('product_flat')
                    ...
                    ->addSelect('marketplace_products.id as marketplace_product_id', 'product_flat.product_id', 'product_flat.sku', 'product_flat.url_key', 'product_flat.name', 'marketplace_products.price', 'product_flat.product_number', 'product_flat.price as   product_flat_price', 'marketplace_products.is_owner', 'marketplace_products.is_approved',  DB::raw('CONCAT(customers.first_name, " ", customers.last_name) as seller_name'), DB::raw('COUNT(marketplace_product_flags.id) as flags'))
